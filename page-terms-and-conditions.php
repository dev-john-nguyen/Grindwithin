		...
		<div id = "display-sessions" class="row align-items-center" style = "text-align: center; padding-bottom: 50px;">
			<div class="col align-items-center" id = "header-content-items">
					...
					<p>
						...
						bound by the terms and provision of this agreement.<br>
						In addition,
						when using these particular services, you shall be subject to any
						posted guidelines or rules applicable to such services.<br>
						Any participation in this service will constitute acceptance
...
<h4  class = "text-center">Intellectual Property</h4>
	<p>
...
<h4  class = "text-center">Changes to This Agreement</h4>
	<p>
